...
async def get_invoices(current_user: dict = Depends(get_current_user)):
    ...
    if (
        ...
        or "Office Manager" in user_roles
    ):
        ...
        if customer_id:
            ...
            customer_name = frappe_client.get_value(
        ...
        raise HTTPException(
            ...
            detail="Not authorized to view invoices.",
        )
    ...
    try:
        invoices = frappe_client.get_list(
            "Invoice",
            filters=filters,
            fields=["name", "project", "amount", "status", "counterparty_type"],
        )
...
async def get_invoice(
    invoice_name: str, current_user: dict = Depends(get_current_user)
):
    user_roles = current_user.get("roles", [])
...
async def create_invoice(
    ...
    current_user: str = Depends(
        has_role(["Project Manager", "Administrator", "Office Manager"])
    ),
):
    try:
