...
if dp and CommandStart:
	...
	async def command_start_handler(message: Message) -> None:  # pragma: no cover - not used without aiogram
...
if dp and Command:
	...
	async def new_request_handler(message: Message) -> None:  # pragma: no cover - not used without aiogram
		raise RuntimeError("Aiogram is not installed; Telegram bot handlers are unavailable.")
...
if dp and Command:
	...
	async def my_requests_handler(message: Message) -> None:  # pragma: no cover - not used without aiogram
		raise RuntimeError("Aiogram is not installed; Telegram bot handlers are unavailable.")
