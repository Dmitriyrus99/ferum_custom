...
if dp and CommandStart:
    ...
    async def command_start_handler(message: Message) -> None:
        ...
        await message.answer(
            f"Hello, {message.from_user.full_name}! I am your Ferum Customizations bot."
        )
    ...
    async def command_start_handler(
        ...
        raise RuntimeError(
            "Aiogram is not installed; Telegram bot handlers are unavailable."
        )
    ...
    async def new_request_handler(message: Message) -> None:
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                ...
                await message.answer(
                    f"New Service Request created successfully! ID: {request_id}"
                )
