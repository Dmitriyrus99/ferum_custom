...
class ActSchedule(Document):
    ...
    def _fill_snapshots(self) -> None:
        ...
        # Best-effort: keep project in sync if there is exactly one Project linked to this Contract.
    ...
    def _compute_planned_submit_date(self) -> None:
        ...
        # planned_submit_date is in the month of period_to with day=deadline_day (clamped to month end)
