...
from apps.ferum_custom.telegram_bot.telegram_bot.frappe import FrappeAPI
from apps.ferum_custom.telegram_bot.telegram_bot.settings import Settings, load_settings
